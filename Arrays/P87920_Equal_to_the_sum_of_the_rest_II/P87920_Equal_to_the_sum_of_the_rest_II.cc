 ...
 * @date Jun 03 2023
 * @brief Programa que, dada una secuencia de números enteros, diga si existe
 ...
 */
void Introduccion() {
  std::cout << "Programa que, dada una secuencia de números enteros, diga si "
               "existe algún número igual a la suma de los demás."
            << std::endl;
  std::cout << "Introduzca la cantidad de números de la secuencua y seguido la "
               "secuencua de números enteros:"
            << std::endl;
}

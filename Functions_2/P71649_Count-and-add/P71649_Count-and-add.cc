/**
  ...
  * @date Dec 1 2022
  * @brief programa que cuenta e imprime la cantidad de numeros de una secuencia y la
  * suma de todos ellos
...
/** Función que imprime la introduccion del programa
  ...
  */
void Introduccion() {
  std::cout << "programa que cuenta e imprime la cantidad de numeros de una "
  << " secuencia y la suma de todos ellos"; 
  std::cout <<  std::endl;
  std::cout <<  "Ingrese uno o dos numeros enteros"; 
  std::cout << std::endl;
}

/** Función que cuenta e imprime la cantidad de numeros de una secuencia y la
  * suma de todos ellos
  * 

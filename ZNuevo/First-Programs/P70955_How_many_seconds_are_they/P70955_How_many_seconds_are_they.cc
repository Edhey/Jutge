...
int main() {
  ...
  int const kConversorAnyos{31536000}, kConversorDias{86400},
      kConversorHoras{3600}, kConversorMinutos{60};
  std::cout << (anyo * kConversorAnyos) + (dias * kConversorDias) +
                   (horas * kConversorHoras) + (minutos * kConversorMinutos) +
                   segundos
            << '\n';
}